...
func setup( context_ball : Ball, context_state_data : BallStateData, context_player_detection : Area2D, context_carrier : Player, context_animation_player : AnimationPlayer, context_sprite : Sprite2D, context_shot_particles : GPUParticles2D ) -> void:
	ball = context_ball
